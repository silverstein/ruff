use crate::Db;
use crate::reachability_constraints::narrow_by_constraint;
...
use ty_semantic_index::{NarrowingEvaluator, place_table};
...
pub(crate) fn accumulate_constraint<'db>(
...
pub(crate) fn evaluate_narrowing_constraint<'db>(
    ...
    narrow_by_constraint(
        db,
        evaluator.reachability_constraints(),
